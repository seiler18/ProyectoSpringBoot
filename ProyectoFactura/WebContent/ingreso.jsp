			...
			<div class="col-12">
				<div class="card">
					<div class="card-body p-0">
						<div class="row p-5">
						  <div class="col-md-6">
                        <h1>Ejercicio : Sistema Factura</h1>
                        </div>

							<div class="col-md-6 text-right">
								<p class="font-weight-bold mb-1">Generador Factura 2020</p>
								<p class="font-weight-bold mb-1">Por Grupo Talento Digital</p>
